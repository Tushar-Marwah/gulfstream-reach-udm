...
SUGGESTED = [
    "Which materials on the G700 contain a REACH SVHC?",
    "Which chemicals are on the REACH Authorisation List (Annex XIV), and by when?",
    "What is the substitution status for strontium chromate, and where is it used?",
    "Which parts use cadmium plating, and on which programs?",
    "What are the hazard statements and exposure limit for hydrazine?",
    "Which suppliers provide chromate primers, and what is their approval status?",
]
